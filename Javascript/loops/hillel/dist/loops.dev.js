...
for (cars = 0; cars < my_car.length; cars++) {
  html += "<p>".concat(my_car[cars].Company, "</p>");
  html += "<div class=\"text_card\"> \u05D3\u05D2\u05DD ".concat(my_car[cars].model, "</div>");
  html += "<img src=\"".concat(my_car[cars].src, "\">");

  if (my_car[cars].Power_horsepower > 500) {
    html += "<div class=\"cohsos\"> ".concat(my_car[cars].Power_horsepower, " \u05DB\u05D7 \u05E1\u05D5\u05E1 \u05D6\u05D4 \u05DE\u05D0\u05D5\u05D3 \u05DE\u05D4\u05D9\u05E8 </div>");
  } else {
    html += "<div class=\"cohsos\"> ".concat(my_car[cars].Power_horsepower, " \u05DB\u05D7 \u05E1\u05D5\u05E1 \u05D6\u05D4 \u05E0\u05D7\u05DE\u05D3 </div>");
  }

  if (my_car[cars].price > 1000000) {
    html += "<div class=\"price\">".concat(my_car[cars].price, "\u20AA \u05DE\u05D7\u05D9\u05E8 \u05DE\u05DE\u05E9 \u05D9\u05E7\u05E8 </div>");
  } else {
    html += "<div class=\"price\">".concat(my_car[cars].price, "\u20AA \u05D6\u05D4 \u05DE\u05D7\u05D9\u05E8 \u05E1\u05D1\u05D9\u05E8 \u05D1\u05E9\u05D1\u05D9\u05DC \u05DC\u05D4\u05E0\u05D5\u05EA </div>");
  }

  if (my_car[cars].Weight > 2000) {
    html += "<div class=\"price\">".concat(my_car[cars].Weight, " \u05D4\u05DE\u05E9\u05E7\u05DC \u05DE\u05DE\u05E9 \u05DB\u05D1\u05D3</div>");
  } else {
    html += "<div class=\"price\">".concat(my_car[cars].Weight, " \u05DE\u05E9\u05E7\u05DC \u05D8\u05D5\u05D1 \u05DC\u05E8\u05DB\u05D1 \u05E1\u05E4\u05D5\u05E8\u05D8 \u05DE\u05E9\u05E4\u05D7\u05EA\u05D9</div>");
  }

  if (my_car[cars].Engine > 4000) {
    html += "<div class=\"price\">\u05DE\u05E0\u05D5\u05E2 ".concat(my_car[cars].Engine, " \u05D6\u05D4 \u05DE\u05E0\u05D5\u05E2 \u05DE\u05E4\u05DC\u05E6\u05EA\u05D9</div>");
  } else {
    html += "<div class=\"price\">\u05DE\u05E0\u05D5\u05E2 ".concat(my_car[cars].Engine, " \u05D6\u05D4 \u05DE\u05E0\u05D5\u05E2 \u05D7\u05D6\u05E7 </div>");
  }

  if (my_car[cars].Speedfrom0to100 > 3.5) {
    html += "<div class=\"price\">\u05DE 0 \u05DC 100 \u05EA\u05D5\u05DA ".concat(my_car[cars].Speedfrom0to100, " \u05D6\u05D4 \u05DE\u05D4\u05D9\u05E8</div>");
  } else {
    html += "<div class=\"price\">\u05DE 0 \u05DC 100 \u05EA\u05D5\u05DA ".concat(my_car[cars].Speedfrom0to100, " \u05DE\u05D0\u05D5\u05D3 \u05DE\u05D4\u05D9\u05E8</div>");
  }

  html += "<div class=\"lochit\">".concat(my_car[cars].literature1, "-").concat(my_car[cars].literature2, "-").concat(my_car[cars].literature3, "</div>");
  car.innerHTML = html;
}
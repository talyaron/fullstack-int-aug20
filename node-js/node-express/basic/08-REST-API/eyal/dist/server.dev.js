  ...
  return regeneratorRuntime.async(function SendMessageToRobot$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regeneratorRuntime.awrap(fetch( //  `https://acobot-brainshop-ai-v1.p.rapidapi.com/get?bid=178&key=sX5A2PcYZbsN5EY6&uid=mashape&msg=${massage}`,
          " https://acobot-brainshop-ai-v1.p.rapidapi.com/get?bid=154389&key=MqKbUKOqNKyU0Dmg&uid=moshe&msg=".concat(massage), {
            method: 'GET',
            headers: {
...
function setKey() {
  var key;
  return regeneratorRuntime.async(function setKey$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return regeneratorRuntime.awrap(fetch("https://translated-mymemory---translation-memory.p.rapidapi.com/createkey", {
            "method": "GET",
            "headers": {
              "x-rapidapi-key": "2dae7de7a8msh9ca6fa97f167561p1494d2jsn956ba9663ea0",
...
var getFaceFromeImage = function getFaceFromeImage(imgeUrl) {
  var form;
  return regeneratorRuntime.async(function getFaceFromeImage$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          form = new FormData(img);
          form.append("image", "".concat(img));
          _context5.next = 4;
          return regeneratorRuntime.awrap(fetch("https://facedetection9.p.rapidapi.com/faces", {
            "method": "POST",
            "headers": {
